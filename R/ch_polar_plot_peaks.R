...
#' @param pt_col colour used for pointsfor events. default = "darkblue". If pt_col is an array it is used to colour 
...
ch_polar_plot_peaks <- function (title = NA, direction=NULL, regularity = NULL, days = NULL, shading = FALSE,
                                 labels=NULL, label_pos = NULL, syms=NULL, cols = NULL, pt_col = "darkblue"){
